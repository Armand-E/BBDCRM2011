...
if (accountId == null || accountId == "" || accountId == " ") {
        ...
        document.all.IFRAME_World_Check.src = 'http://jhbh-srv-crm01:8008/CrmWorldCheck.html?AccountId=' + accountId;
    };
...
crmForm.all.accountratingcode_c.style.color = '#32cd32';
crmForm.SetFieldReqLevel("accountratingcode", 1);
...
function isp_companyregistrationnumber_onchange() {
 ...
 function validateCompanyRegno(nr) {
        ...
        function isInArray(nr) {
            var arr = ["06", "07", "08", "10", "11", "20", "21", "22", "23", "24", "25", "26", "30", "31"];
...
function isRequiredNone(strLegalEntity)
		{
			...
			var arr = ['6','15','16','7','23','24','25','26','27','28','11','12','13','9'];
			var found = false;
			for (var i in arr) {
...
function isRequiredNoneOnLoad(strLegalEntity)
		{
			...
			var arr = ['6','15','16','7','23','24','25','26','27','28','9'];
			var found = false;
			for (var i in arr) {
                if (arr[i] == strLegalEntity)
                    found = true;
