...
{
var exclude = [140,79,18,145,42,71,26,5,29,8,17,88,30,106,73,60,82,107,12,2,28,70,72,85,7,75,45,22,31,90,77,50,91,44,46,92,23,109,55,1,16,129,11,94,24,6,14,74,76,104,80,3,41,84,15,8,89,37,103,78,33,40];
var list = document.getElementById("isp_owner");
var options = list.getElementsByTagName("OPTION");
for (var e = 0; e < exclude.length; e++) {

    for (var i = 0; i < options.length; i++) {

        if (options[i].value == exclude[e]) {
