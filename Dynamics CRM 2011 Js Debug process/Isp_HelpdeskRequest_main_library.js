...
isp_closeCall = function() {
 if ((crmForm.all.isp_resolution.DataValue == null) || (crmForm.all.isp_resolution.DataValue == "")) {
...
{
    crmForm.all(iframename).style.height = "19px";
    ...
    i.writeln("window.parent.document.all."+fieldname+".DataValue = '';");
    i.writeln("window.parent.document.all."+fieldid+".DataValue = '';");
    i.writeln("window.parent.document.all."+fieldtype+".DataValue = null;");
//Save field for lookup
      if (savefield != "none")  i.writeln("window.parent.document.all."+savefield+".DataValue = '';");
//------------------------
    ...
    i.writeln("window.parent.document.all."+fieldname+".DataValue = x.items[0].name;");
    i.writeln("window.parent.document.all."+fieldid+".DataValue = x.items[0].id;");
    i.writeln("window.parent.document.all."+fieldtype+".DataValue = x.items[0].type - 0;");
//Save field for lookup
   if (savefield != "none")  i.writeln("window.parent.document.all."+savefield+".DataValue = x.items[0].name;");
//------------------------
    ...
    i.writeln("var s = window.parent.document.all."+fieldid+".DataValue");
    i.writeln("var t = window.parent.document.all."+fieldtype+".DataValue");
    i.writeln("if (t==1) {");
    ...
    {
    document.frames(iframename).document.all.txtLink.innerText = crmForm.all(fieldname).DataValue;
...
try {
//recapture info
window.frames("IFRAME_recap").document.all("txtName").value= crmForm.all.isp_name.DataValue == null? "": crmForm.all.isp_name.DataValue;
window.frames("IFRAME_recap").document.all("txtSurname").value= crmForm.all.isp_surname.DataValue==null?"":crmForm.all.isp_surname.DataValue;
window.frames("IFRAME_recap").document.all("txtTel").value= crmForm.all.isp_telno.DataValue==null?"":crmForm.all.isp_telno.DataValue;
window.frames("IFRAME_recap").document.all("txtCell").value= crmForm.all.isp_cellno.DataValue==null?"":crmForm.all.isp_cellno.DataValue;
window.frames("IFRAME_recap").document.all("txtEmail").value= crmForm.all.isp_email.DataValue==null?"":crmForm.all.isp_email.DataValue;
window.frames("IFRAME_recap").document.all("DLBranch").value= crmForm.all.isp_branch.DataValue;
window.frames("IFRAME_recap").document.all("dlPriority").value = crmForm.all.isp_priority.DataValue;
window.frames("IFRAME_recap").document.all("txtDescription").value= crmForm.all.isp_description.DataValue==null?"":crmForm.all.isp_description.DataValue;
} catch (ex) { setTimeout("isp_cap();", 500);}
}
crmForm.all.tab3Tab.onclick = function() {
setTimeout("isp_cap();", 500);
}
{
if (crmForm.all.isp_hasaccepted.DataValue == true) {
    crmForm.all.isp_hasaccepted.Disabled = 1;
    crmForm.all.isp_datetimeaccepted.Disabled = 1;
    crmForm.all.isp_hasaccepted.ForceSubmit = true;
    crmForm.all.isp_datetimeaccepted.ForceSubmit = true;
}
else {
    crmForm.all.isp_hasaccepted.Disabled = 0;
}
}
}
...
if (crmForm.all.isp_hasaccepted.DataValue == true) {
    ...
    crmForm.all.isp_datetimeaccepted.DataValue = today;
    crmForm.all.isp_hasaccepted.Disabled = 1;
    crmForm.all.isp_datetimeaccepted.Disabled = 1;
    crmForm.all.isp_hasaccepted.ForceSubmit = true;
    crmForm.all.isp_datetimeaccepted.ForceSubmit = true;
